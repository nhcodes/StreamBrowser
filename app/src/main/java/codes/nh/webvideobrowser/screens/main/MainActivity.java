...
import codes.nh.webvideobrowser.screens.bookmark.BookmarksFragment;
import codes.nh.webvideobrowser.screens.browser.BrowserViewModel;
import codes.nh.webvideobrowser.screens.cast.CastFullControllerFragment;
import codes.nh.webvideobrowser.screens.cast.CastManager;
import codes.nh.webvideobrowser.screens.cast.CastViewModel;
import codes.nh.webvideobrowser.screens.help.HelpFragment;
import codes.nh.webvideobrowser.screens.history.HistoryFragment;
import codes.nh.webvideobrowser.screens.history.HistoryViewModel;
import codes.nh.webvideobrowser.screens.settings.SettingsFragment;
import codes.nh.webvideobrowser.screens.settings.SettingsManager;
import codes.nh.webvideobrowser.screens.sheet.SheetManager;
import codes.nh.webvideobrowser.screens.sheet.SheetRequest;
import codes.nh.webvideobrowser.screens.stream.Stream;
import codes.nh.webvideobrowser.screens.stream.StreamViewModel;
import codes.nh.webvideobrowser.screens.stream.StreamsFragment;
